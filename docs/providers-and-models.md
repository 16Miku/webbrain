...
| `webgpu` (Chromium) | `webgpu` | local | Ling 3.0 Tiny (default), Qwen3 0.6B, Gemma 4 E2B QAT Mobile, or custom HF repo | No |
...
about 2.32 GB; its image and audio encoders are not loaded. Each repository is
cached separately in Chrome. **Test Connection**
