...
For X direct messages, a mounted but empty log is treated as loading rather than as a proven first-message conversation. Dispatch and completion require a settled, nonempty conversation tail before a later matching sent row can be accepted.
