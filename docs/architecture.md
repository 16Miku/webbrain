...
issued transaction state or recipient-bound sent-message state). Repeated jobs
must exactly reconcile terminal ledger IDs against a complete app-owned
accessibility-tree or seeded inventory; model-created rows alone cannot prove
