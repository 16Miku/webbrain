...
const fonts = {
  serif: fontUri('instrument-serif-400.woff2'),
...
const baseCss = `
  ...
  * { box-sizing: border-box; }
  ...
  .eyebrow {
    ...
    border-radius: 999px; font-family: var(--mono); font-size: 13px; font-weight: 600;
    text-transform: uppercase; letter-spacing: 0.11em; line-height: 1;
  }
  ...
  h1 {
    margin: 18px 0 0; font-family: var(--display); font-size: 66px; line-height: 1.02;
    font-weight: 400; letter-spacing: -0.015em; text-wrap: balance;
  }
  .sub { margin-top: 16px; color: var(--muted); font-size: 24px; font-weight: 450; letter-spacing: -0.005em; }
  .num { font-family: var(--display); font-weight: 400; letter-spacing: -0.02em; }
  .crop-frame {
  ...
  return {
    ...
    body: `
      <div style="height:100%; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center;">
        <div style="font-family:var(--mono); font-size:15px; font-weight:600; letter-spacing:0.3em;
          text-transform:uppercase; color:var(--muted);">WebBrain</div>
        <h1 style="margin-top:28px; font-size:88px; line-height:1.0; max-width:960px;">Your open-source<br>AI browser agent</h1>
        <div class="sub" style="font-size:29px; font-weight:550; color:var(--ink); margin-top:26px;">
        ...
        <div style="display:flex; gap:10px; margin-top:30px;">
          ${['Chromium browsers and Firefox', 'Local or cloud models', 'MIT licensed'].map((c) => `
            <span style="padding:11px 16px; border:1px solid var(--border); background:var(--panel);
              border-radius:999px; font-family:var(--mono); font-size:12.5px; font-weight:600;
              letter-spacing:0.08em; text-transform:uppercase; color:var(--muted);">${c}</span>`).join('')}
        </div>
      </div>`,
  };
}
    ...
    body: `
      ...
      <div style="display:grid; grid-template-columns: 1fr 360px; gap:24px; width:1060px; margin:44px auto 0; align-items:stretch;">
        ...
        <div style="background:#171827; border:1px solid rgba(255,255,255,0.12); border-radius:20px; padding:20px;
          ...
          <div style="font-family:var(--mono); font-size:12.5px; font-weight:600; color:#aeb4c9;
            text-transform:uppercase; letter-spacing:0.11em; margin-bottom:16px;">WebBrain is acting</div>
      ...
      <div style="display:grid; grid-template-columns: 500px 1fr; gap:48px; align-items:center; height:calc(100% - 60px);">
        ...
        <div style="display:flex; justify-content:center;">
          <div style="width:470px; padding:28px; background:${card.bg}; border:1px solid ${card.border};
            ...
            <div style="font-family:var(--mono); font-size:12.5px; font-weight:600; color:${card.label};
              text-transform:uppercase; letter-spacing:0.11em;">Proposed browser plan</div>
    ...
    body: `
      ...
      <div style="height:calc(100% - 60px); display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center;">
        ...
        <div style="display:flex; align-items:baseline; gap:28px; margin-top:30px;">
          <span class="num" style="font-size:74px; line-height:1; color:var(--muted); text-decoration:line-through;
            text-decoration-thickness:3px; text-decoration-color:var(--accent);">$8</span>
          <span class="num" style="font-size:132px; line-height:1;">$5<span style="font-family:var(--ui); font-size:32px; font-weight:600; color:var(--muted); letter-spacing:0; margin-left:4px;">/mo</span></span>
      ...
      <div style="display:grid; grid-template-columns:repeat(3, 1fr); gap:26px; width:1120px; margin:52px auto 0;">
        ${stats.map(([glyph, value, label]) => `
          <div style="background:var(--panel); border:1px solid var(--border); border-radius:26px;
            ...
            <div class="num" style="margin-top:20px; font-size:94px; line-height:1;">${value}</div>
