...
const PROVIDERS = [
  ...
  provider('pollinations', 'Pollinations AI', 'https://gen.pollinations.ai/v1', 'openai', 131072, { category: 'router', apiKeyUrl: 'https://enter.pollinations.ai/keys', supportsVision: true, supportsAskStreaming: true, supportsStreamUsageOptions: true, inputCostPerMillionUsd: 0, outputCostPerMillionUsd: 0, suggestions: ['openai', 'claude', 'gemini', 'deepseek', 'qwen'] }),
