...
export const STATE_CHANGE_TOOLS = new Set(['navigate', 'carousel_navigate', 'promote_iframe', 'new_tab', 'delegate_research', 'go_back', 'go_forward', 'click', 'click_ax', 'set_checked', 'iframe_click', 'type_text', 'type_ax', 'set_field', 'iframe_type', 'press_keys', 'scroll', 'hover', 'drag_drop', 'execute_js']);
