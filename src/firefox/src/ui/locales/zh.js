...
export default {
  ...
  "st.providers.webbrain_data_use.body": "WebBrain Cloud 包含每日免费用量。帮助改进 WebBrain 默认开启时，选定的 Cloud 对话可能会被保留，并用于评估、改进、微调和训练。可在“常规 → 高级”中关闭，以排除未来的 Cloud 交互。<u>WebBrain 绝不会收集本地模型请求或使用您自己的 API 凭据直接发送的请求。</u>{privacyLink}。如需更多用量，请在 {subscribeLink} 订阅。在 {accountLink} 管理账单。",
