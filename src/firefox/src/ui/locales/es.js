...
export default {
  ...
  "st.providers.webbrain_data_use.body": "Se incluye uso diario gratuito de WebBrain Cloud. Mientras Ayuda a mejorar WebBrain está activado de forma predeterminada, algunas conversaciones de Cloud pueden conservarse y utilizarse para evaluación, mejora, ajuste fino y entrenamiento. Desactívalo en General → Avanzado para excluir futuras interacciones de Cloud de esos usos. <u>WebBrain nunca recopila solicitudes de modelos locales ni solicitudes enviadas con tus propias credenciales de API.</u> {privacyLink}. Para obtener más uso, suscríbete en {subscribeLink}. Gestiona la facturación en {accountLink}.",
