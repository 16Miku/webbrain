...
export default {
  ...
  'st.providers.webgpu_note.managed_body': '{modelLink} runs entirely in Chrome with no API endpoint. Download and manage the model files below. Test Connection checks the packaged runtime and hardware adapter without downloading the model.',
  'st.providers.webgpu_download.title': 'Ling model files',
  'st.providers.webgpu_download.progress_label': 'Ling model download progress',
  ...
  'st.providers.webgpu_download.required': 'Download Ling before selecting WebGPU for chat.',
  ...
  'st.providers.webgpu_download.activate_blocked': 'Download Ling before selecting WebGPU for chat.',
};
