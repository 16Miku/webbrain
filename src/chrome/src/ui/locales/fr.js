...
export default {
  ...
  "st.providers.webbrain_data_use.body": "Une utilisation quotidienne gratuite de WebBrain Cloud est incluse. Tant que Aider à améliorer WebBrain est activé par défaut, certaines conversations Cloud peuvent être conservées et utilisées pour l’évaluation, l’amélioration, l’ajustement fin et l’entraînement. Désactivez cette option dans Général → Avancé pour exclure les futures interactions Cloud de ces usages. <u>WebBrain ne collecte jamais les requêtes de modèles locaux ni celles envoyées avec vos propres identifiants d’API.</u> {privacyLink}. Pour davantage d’utilisation, abonnez-vous sur {subscribeLink}. Gérez la facturation sur {accountLink}.",
