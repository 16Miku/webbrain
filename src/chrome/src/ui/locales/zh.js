...
export default {
  ...
  "st.display.help_improve.desc_html": "允许保留选定的 WebBrain Compass 交互，并将其用于评估、改进、微调和训练。此选项默认开启。关闭后，未来的 Cloud 交互将不会用于这些用途。<u>WebBrain 绝不会收集本地模型请求或使用您自己的 API 凭据直接发送的请求。</u><a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">隐私政策 →</a>",
