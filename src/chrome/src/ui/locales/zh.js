...
export default {
  ...
  'st.system_one.desc_html': 'Optionally use <a href="https://typesafe.ai" target="_blank" style="color:var(--accent);">TypeSafe System One</a> as a second opinion for scheduled watches and task completion. It only judges the bounded task and latest observation; it never controls the browser.',
  'st.system_one.enabled.label': 'Enable TypeSafe System One',
  'st.system_one.enabled.desc': 'Opt in globally before enabling either scheduled-task guard. Off by default.',
  'st.system_one.api_key.label': 'TypeSafe API Key',
  'st.system_one.watch.label': 'Judge scheduled watches',
  'st.system_one.watch.desc': 'Downgrade a watch success to a poll when the condition or evidence looks uncertain.',
  'st.system_one.completion.label': 'Judge scheduled task completion',
  'st.system_one.completion.desc': 'Downgrade an optimistic scheduled-task success when completion evidence looks uncertain.',
  'st.system_one.watch_threshold': 'Watch confidence threshold',
  'st.system_one.completion_threshold': 'Completion confidence threshold',
  'st.system_one.save': 'Save Settings',
  'st.system_one.clear': 'Clear',
  'st.system_one.saved': 'Saved. TypeSafe System One is configured.',
  'st.system_one.cleared': 'Cleared.',
  'st.system_one.need_key': 'Enter a TypeSafe API key before enabling System One.',
  'st.system_one.security_html': '<strong>Privacy and cost:</strong> this feature is off until you opt in. The extension sends the task and a bounded latest observation to TypeSafe using your own API key. It does not send screenshots, audio, or provider credentials. The key is stored in plaintext in browser local storage; TypeSafe may charge your account. Strict Secret Mode disables this sidecar.',
