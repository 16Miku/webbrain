...
const englishApocalypseModeCopy = {
  ...
  'ap.hero.consent': 'Nothing is downloaded until you enable this mode. Wikipedia archives still require confirmation.',
  ...
  'ap.download_background': 'Downloads continue in the background if you leave or close this page. Reopen Apocalypse Mode to check progress.',
