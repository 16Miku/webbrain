...
export default {
  ...
  "st.display.help_improve.desc_html": "選択された WebBrain Compass の操作を保持し、評価、改善、微調整、トレーニングに使用することを許可します。既定でオンです。今後の Cloud 操作がこれらの目的に使用されないようにするにはオフにしてください。<u>ローカルモデルへのリクエストや、ご自身の API 認証情報で直接送信したリクエストを WebBrain が収集することはありません。</u><a href=\"https://webbrain.one/privacy\" target=\"_blank\" rel=\"noopener noreferrer\" style=\"color:var(--accent);\">プライバシーポリシー →</a>",
