...
export default {
  ...
  "st.providers.webbrain_data_use.body": "WebBrain Cloud에는 일일 무료 사용량이 포함됩니다. ‘WebBrain 개선에 참여’가 기본적으로 켜져 있는 동안 선택된 Cloud 대화가 보관되어 평가, 개선, 미세 조정 및 학습에 사용될 수 있습니다. 향후 Cloud 상호작용을 이러한 사용에서 제외하려면 일반 → 고급에서 끄세요. <u>로컬 모델 요청과 사용자의 API 자격 증명으로 직접 전송한 요청은 WebBrain이 수집하지 않습니다.</u> {privacyLink}. 더 많은 사용량이 필요하면 {subscribeLink}에서 구독하세요. 청구는 {accountLink}에서 관리하세요.",
